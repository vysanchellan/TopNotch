...
const RippleButton: React.FC<RippleButtonProps> = ({
  ...
  const baseClasses = "relative border-none overflow-hidden isolate transition-all duration-200 cursor-pointer px-4 py-2 bg-gold-mid hover:bg-gold-light text-black rounded-lg";
